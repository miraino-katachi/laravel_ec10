...
<div class="row justify-content-center">
    <div class="col-md-6">
        <h2>会員情報修正</h2>
        <form action="{{ route('user.update', $user_info) }}" method="post">
            @csrf
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" placeholder="未来　太郎" class="form-control
                        @error('full_name')
                            is-invalid
                        @enderror
                        " id="full_name" name="full_name" value="{{ old('full_name', $user_info->full_name) }}"
                ...
                <div class="col-sm-9">
                    <input type="text" placeholder="090-0000-0000" class="form-control
                        @error('tel')
                            is-invalid
                        @enderror
                        " id="tel" name="tel" value="{{ old('tel', $user_info->tel) }}"
                ...
                <div class="col-sm-9">
                    <input type="text" placeholder="大阪府" class="form-control
                        @error('pref')
                            is-invalid
                        @enderror
                        " id="pref" name="pref" value="{{ old('pref', $user_info->pref) }}"
                ...
                <div class="col-sm-9">
                    <input type="text" placeholder="大阪市西区" class="form-control
                        @error('city')
                            is-invalid
                        @enderror
                        " id="city" name="city" value="{{ old('city', $user_info->city) }}"
                ...
                <div class="col-sm-9">
                    <input type="text" placeholder="阿波座1-13-16" class="form-control
                        @error('town')
                            is-invalid
                        @enderror
                        " id="town" name="town" value="{{ old('town', $user_info->town) }}"
                ...
                <div class="col-sm-9">
                    <input type="text" placeholder="松本フォレストビル501" class="form-control
                        @error('building')
                            is-invalid
                        @enderror
                        " id="building" name="building" value="{{ old('building', $user_info->building) }}"
